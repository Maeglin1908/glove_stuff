...
#define KEY_LH_T1 BACKSPACE
#define KEY_LH_T2 LALT
#define KEY_LH_T3 ESC
#define KEY_RH_T3 HOME
#define KEY_RH_T2 END
#define KEY_RH_T1 0
...
#define KEY_LH_T5 RET
#define KEY_LH_T6 LCTRL
#define KEY_RH_T6 LGUI
#define KEY_RH_T5 RALT
#define KEY_RH_T4 RSHFT
